                        ...
                        child: BlocBuilder<DomainBloc, DomainState>(
                          builder: (context, state) {
                            if (state is DomainStateLoadedIsFavorite) {
                              ...
                              return _favoriteManagement();
                            } else if (state is DomainStateLoaded) {
                              return _favoriteManagement();
                            } else {
                              return const Align(
                                  alignment: Alignment.center,
                      ...
                      children: [
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        color: const Color.fromARGB(
                                            255, 65, 208, 252),
                                        child: SizedBox(
                                          height: pokemon!.stats[0].baseStat!
                                              .toDouble(),
                                          width: 45,
                                        )),
                                    const SizedBox(
                                    ...
                                    Container(
                                        color: const Color.fromARGB(
                                            255, 231, 48, 48),
                                        child: SizedBox(
                                          height: pokemon!.stats[1].baseStat!
                                              .toDouble(),
                                          width: 45,
                                        )),
                                    const SizedBox(
                                    ...
                                    Container(
                                        color: const Color.fromARGB(
                                            255, 245, 170, 58),
                                        child: SizedBox(
                                          height: pokemon!.stats[2].baseStat!
                                              .toDouble(),
                                          width: 45,
                                        )),
                                    const SizedBox(
                                    ...
                                    Container(
                                        color: const Color.fromARGB(
                                            255, 25, 226, 35),
                                        child: SizedBox(
                                          height: pokemon!.stats[3].baseStat!
                                              .toDouble(),
                                          width: 45,
                                        )),
                                    const SizedBox(
                                    ...
                                    Container(
                                        color: const Color.fromARGB(
                                            255, 224, 100, 42),
                                        child: SizedBox(
                                          height: pokemon!.stats[4].baseStat!
                                              .toDouble(),
                                          width: 45,
                                        )),
                                    const SizedBox(
                                    ...
                                    Container(
                                        color: const Color.fromARGB(
                                            255, 29, 15, 219),
                                        child: SizedBox(
                                          height: pokemon!.stats[5].baseStat!
                                              .toDouble(),
                                          width: 45,
                                        )),
                                  ],
                        ...
                        BlocListener<DomainBloc, DomainState>(
                          ...
                          child: BlocProvider(
                            ...
                            child: BlocBuilder<DomainBloc, DomainState>(
                              builder: (context, state) {
                                if (state is DomainStateLoadedDescription) {
    ...
    return IconButton(
        ...
        onPressed: () async {
          setState(() {
            if (!favorite!) {
              if (!_favoriteBloc.isClosed) {
                _favoriteBloc.add(AddFavoriteEvent(pokemon!.name));
              }
            } else {
              if (!_favoriteBloc.isClosed) {
                _favoriteBloc.add(RemoveFavoriteEvent(pokemon!.name));
              }
            }
          });
        },
